    ...
    /* [in] */ unsigned long offset)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[46],
                  ( unsigned char * )&h_gdipp_rpc);
    ...
    /* [in] */ unsigned long buf_size)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[98],
                  ( unsigned char * )&h_gdipp_rpc);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [context_handle_noserialize][in] */ GDIPP_RPC_SESSION_HANDLE h_session)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[162],
                  ( unsigned char * )&h_gdipp_rpc);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [in] */ unsigned long buf_size)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[202],
                  ( unsigned char * )&h_gdipp_rpc);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [size_is][out] */ unsigned short *gi)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[254],
                  ( unsigned char * )&h_gdipp_rpc);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [in] */ boolean is_glyph_index)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[312],
                  ( unsigned char * )&h_gdipp_rpc);
    ...
    /* [context_handle_noserialize][in] */ GDIPP_RPC_GLYPH_RUN_HANDLE h_glyph_run)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[370],
                  ( unsigned char * )&h_gdipp_rpc);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [in] */ unsigned long glyph_run_size)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[410],
                  ( unsigned char * )&h_gdipp_rpc);
    ...
    /* [out][in] */ GDIPP_RPC_GLYPH_RUN_HANDLE *h_glyph_run)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[462],
                  ( unsigned char * )&h_gdipp_rpc);
    return ( boolean  )_RetVal.Simple;
    ...
    /* [out][in] */ GDIPP_RPC_SESSION_HANDLE *h_session)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&gdipp_rpc_StubDesc,
                  (PFORMAT_STRING) &gdipp_rpc__MIDL_ProcFormatString.Format[502],
                  ( unsigned char * )&h_gdipp_rpc);
    return ( boolean  )_RetVal.Simple;
